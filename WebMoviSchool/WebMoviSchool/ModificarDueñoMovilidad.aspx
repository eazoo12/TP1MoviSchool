<%@ Page Title="" Language="C#" MasterPageFile="~/MaestroMovilidad.Master" AutoEventWireup="true" CodeBehind="ModificarDueñoMovilidad.aspx.cs" Inherits="WebMoviSchool.ModificarMovilidad" %>
       ...
       <table style="width:100%;">
           <tr>
               <td class="align-center">
                   <strong>Modificación de Datos del Dueño de Movilidad</strong><br />
                    <table style="width:100%";>
                <tr>
            ...
            <table class="auto-style4">
                <tr>
                    ...
                    <td class="auto-style3">Correo Electrónico:
                        <asp:TextBox ID="txtCorreo" runat="server"  Height="31px" Width="256px" placeholder="Ingrese correo electrónico"></asp:TextBox>
